...
const About = () => {
  ...
  console.log(index);
  return (
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left max-h-full overflow-y-auto">
      <Circles />
      <motion.div
            ...
            {aboutData.map((item, itemIndex) => {
              return (
                <div
                  ...
                  } cursor-pointer capitalize xl:text-lg relative after:w-8 afterr:h-[2px] after:bg-white after:absolute after:-bottom-1 after:left-0`}
